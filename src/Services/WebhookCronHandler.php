...
class WebhookCronHandler extends CronHandler
{
     ...
     */
    public function __construct(ConfigRepository $config, PaymentHelper $paymentHelper, PaymentService $paymentService, TrustPaymentsSdkService $sdkService, WebhookRepositoryContract $webhookRepository)
    {
        $this->config = $config;
